...
from .views import change_permission, delete_note, delete_share, get_note_by_id, get_share_note, get_shared_note, manage_share, share_note, update_note, view_note
...
urlpatterns = [
    ...
    path('delete-share/<int:share_id>/', delete_share, name='note'),
